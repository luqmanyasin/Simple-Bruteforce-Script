...
<script>
    ...
    if(!named || !action || !method || !values){
      $('.forms').append('<form action="" style="margin:50px auto" method="GET"><input type="text" name="m" placeholder="Form Method" class="u-full-width" /> <br /> <input type="text" name="n" placeholder="Input name" class="u-full-width" /> <br /> <input type="text" name="a" placeholder="Action URL" class="u-full-width" /> <br /> <textarea name="values" placeholder="Enter Values - Seperate each character with a \',\' comma." class="u-full-width" ></textarea> <input type="text" name="u" placeholder="Username or Email" class="u-full-width"/> <input type="text" name="un" placeholder="Username or Email Input Name" class="u-full-width"/> <input type="submit"  class="u-full-width"/> </form>');
      throw new Error();
    }
