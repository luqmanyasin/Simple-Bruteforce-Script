...
return array;}
function getComb(array){var arr=array.split(',');var arrCount=arr.length;maxComb=Math.pow(arrCount,arrCount);var res=[];if(arrCount>1){for(i=0;i<maxComb;i++){shuffleArray(arr);if($.inArray(arr.join(''),res)==-1){res.push(arr.join(''));}}}
return(res);}
...
return vars;}
function openThisWindow(data){var w=window.open("","Form Output","width=600,height=700");$(w.document.body).html(data)}
